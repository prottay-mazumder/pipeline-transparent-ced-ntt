...
REM
REM Generated by Vivado on Tue May 26 17:03:40 +0600 2026
...
echo "xvlog --incr --relax -prj tb_top_pipelined_vlog.prj"
call xvlog  --incr --relax -prj tb_top_pipelined_vlog.prj -log xvlog.log
